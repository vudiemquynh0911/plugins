...
//      startPreview();
  ...
  private void parseVideo(String mFilePath, @NonNull final Result result) {
    try {
      ...
      if (isError) {
        videoRecordingFile = getOutputMediaFile(mFilePath);
        ...
        FileChannel fc = new RandomAccessFile(mFilePath, "rw").getChannel();
  ...
  private File getOutputMediaFile(String mFilePath) {
